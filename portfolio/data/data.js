var json = {
	...
	"genwi_fw" : {
		...
		"writeup" : "<b>SUMMARY</b> <br>Genwi Technologies, 2013-14 <br>Front end web framework to simplify and standardise the app development process at Genwi reduciung the turnaround time to develop new apps for customers.The preview shows the most important features of the framework and their significance.<p> <b>ROLE</b><br> Contributed to the initial design and use case research with team lead. Lead developer.</p> ",
		"images" : [
	...
	"genwi_apps" : {
		...
		"writeup" : "<b>SUMMARY</b><br>Genwi Technologies, 2013-*<br>The preview here shows a couple of projects where the customer requirements involved designs which were innovative and never done before.  We had to take care of many usecases in terms of how the end user can use the interface.Genwi Apps are hybrid; so the design were implemented using front end web tools and as such the limitation posed by tools also had to be taken care of.</p> <p><b>ROLE</b><br> Lead Developer, Designer.</p>",
		"htmls" : [
			"<div style='text-align: center;padding-top: 20px;width:80%;margin: auto;'><h2> MAGAZINE LAYOUT ( CUSTOMER - CA TECHNOLOGIES)</h2><br><br><br><div style='display: inline-block;width:55%;vertical-align: top; margin-right:30px;text-align: left;'>This particular customer requirement required us to design a magazine-like experience for tablets. If we see the way we hold our tablet, its almost like a book or magazine. Hence, having a multi-columnn magazine layout does make sense because the user already has experience to that kind of UI and it makes good case of displaying content in a larger area.<p>There were some key points with which we designed and implemented this layout considering the way user reads a magazine and also the customer needs.</p><p>1. The ability to swipe and move to next page just like we do flip to move to next page in magazine.</p><p>2. Glass effect or the feature of dragging a page. (Check video at 1-3 sec). This adds to the whole magazine experience by maintaining a skeuomorphism effect	.</p><p>3. Apart from this we also added indicators (middle left) to make sure the user has a sense of how much pages are there and what page he is on.</p><p>4. Also the code was written in such a way so that customer is able to customize the layout in terms of adding inline images and other styling changes.<p></div><div style='display: inline-block;width:40%'><iframe width='100%' height='315' src='https://www.youtube.com/embed/jYYxyEJT4f4' frameborder='0' allowfullscreen ></iframe></div></div>",
			"<div style='text-align: center;padding-top: 20px;width:80%;margin: auto;'><h2> FLIPVIEW LAYOUT (CUSTOMER - NVISION)</h2><br><br><br><div style='display: inline-block;width:55%;vertical-align: top; margin-right:30px;text-align: left;'>This customer project involved showing the data between different categories using a 3d flip. A 3d flip is different from normal swipe in a way that the slide is rotated instead of animating left or right. The video shows a demo of the implementation we open sourced after doing the customer project. (check open source project <a href='https://github.com/agaase/flipview'>here.</a>)<p>There were many points that we took care of in terms of how the user will interact with a layout like this.</p><p>1. The ability to quickly flip to the next slide by doing a swipe using touch. (Check 6-9 sec in video)</p><p>2. Panning effect in which case the user can drag the slide instead of quickly flipping it allowing him to see the back and front slide simulataneously. At the same time it also provides a skeuomorphism effect.(Check 19-27 sec in video). </p><p>3. An appearance that slide moves inside and as such looks smaller when the flip or dragging is done. This also makes sure that when the slide is rotated it doesn't gets cut at the device boundaries.</p></div><div style='display: inline-block;width:40%'><iframe width='100%' height='315' src='https://www.youtube.com/embed/CTRnyGKhBuo' frameborder='0' allowfullscreen ></iframe></div></div>",
		]
	}, 
	"spotify" : {
		"title" : "Help me Spotify!",
		"writeup" : "<b>SUMMARY</b><br>Personal project, 2014 <br>A design analysis as part of the blog -  Designalysed. It discusses the many usecases the Spotify offers, the paint points and bad design user faces and what could be done to improve them. Read full blog here - http://bit.ly/des_spotify.<p> <b>ROLE</b><br> Analyse the usecases of products in terms of user experience, design mockups for alternate designs to various layouts.</p>",
		"images" : [
	...
	"mnu" : {
		"title"  : "Magazine & You",
		"writeup" : "<b>SUMMARY</b><br>Personal project, 2012-2013<br>An online community of magazine lovers where people can share and discuss different things related to magazines. This preview shows the screenshots of different parts of the desktop portal. Check live website here- www.magnyou.in <p><b>ROLE</b><br> Founded the online community and also did the design, development of the portal.</p> ",
		"images" : [
